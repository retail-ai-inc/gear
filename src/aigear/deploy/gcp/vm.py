...
if __name__ == "__main__":
    ...
    try:
        ...
        list_instances(default_project_id, instance_zone)

# gcloud compute ssh --project=ssc-ape-staging --zone=asia-northeast1-a aigear-test-vm
# gcloud compute instances create-with-container test-vm --container-image gcr.io/cloud-marketplace/google/nginx1:latest